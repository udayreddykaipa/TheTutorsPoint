...
<form>
    ...
    <div class="form-group">
        <label for="exampleInputQualificaion">Highest education Qualification</label>
        <input required type="text" class="form-control" id="exampleInputQualificaion">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <small id="locationS" class="form-text text-muted">We'll need it to show nearby Tuition. </small>
    </div>
    <div class="form-group">
